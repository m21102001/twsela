...
import 'package:twsela/modules/home_pages/my_trips_screen.dart';
import 'package:twsela/modules/home_pages/promotions_screen.dart';
    ...
    return BlocConsumer<AppCubit, AppStates>(
      ...
      builder: (context, state) {
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(onPressed: (){}, icon: Icon(Icons.notifications_none_rounded, color: Colors.white,size: 28,))
          ],
        ),
        body: Stack(
          children: [
                                ...
                                Row(
                                  children: [
                                    Expanded(child: TabItem(
                                        ...
                                        isSelected: cubit.profileIndex==0? true: false,
                                        function: (){
                                          cubit.changeProfileIndex(0);
                                        })),
                                    Expanded(child: TabItem(
                                        header: 'Settings',
                                        isSelected: cubit.profileIndex==1? true: false,
                                        function: (){
                          ...
                          child: Column(
                            children: [
                              Row(
                                ...
                                children: [
                                  Icon(Icons.email_rounded, color: secondaryColor,),
                                  const SizedBox(width: 10.0,),
                                  Text(
                                    'mohamedfayoumy@gmail.com',
                              ...
                              Row(
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  Icon(Icons.location_on_sharp, color: secondaryColor,),
                                  const SizedBox(width: 10.0,),
                                  Text(
                                    'banha/qalyobia/egypt',
                                    style: GoogleFonts.openSans(
                                      fontWeight: FontWeight.w700,
                                      fontSize: 16.0,
                                      color:const Color(0xff2F2E2E),
                      ...
                      fallback:(context)=> Expanded(
                        child: SingleChildScrollView(
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ProfileButton(icon: Icons.file_copy_sharp, text: 'My Trips', function: (){
                                  navigateTo(context, MyTripsScreen());
                                }),
                                SizedBox(height: 20.h,),
                                ProfileButton(icon: Icons.discount, text: 'My Promotions', function: (){
                                  navigateTo(context, PromotionsScreen());
                                }),
                                SizedBox(height: 20.h,),
                                ProfileButton(icon: Icons.mode_edit_outline_rounded, text: 'Edit Profile', function: (){
                                  navigateTo(context, EditScreen());
                                }),
                                SizedBox(height: 20.h,),
                                ProfileButton(icon: Icons.logout, text: 'Log out', function: (){
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: (){},
          backgroundColor: secondaryColor,
          child: Icon(Icons.support_agent_rounded,  size: 32.r,),
        ),
      );
      },
    );
...
class ProfileButton extends StatelessWidget {
  const ProfileButton({Key? key, required this.text,required this.icon, required this.function}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(color:isSelected ? secondaryColor.withOpacity(0.7) : Colors.grey[300]!)
        ),
        child: Row(
